...
export const GET_PENDING_INVENTORIES_STARTED =
  "GET_PENDING_INVENTORIES_STARTED";
export const GET_PENDING_INVENTORIES_FULFILLED =
  "GET_PENDING_INVENTORIES_FULFILLED";
export const GET_PENDING_INVENTORIES_REJECTED =
...
export const SET_UPDATING_INVENTORY_FULFILLED =
  "SET_UPDATING_INVENTORY_FULFILLED";
...
export function getInventories(data) {
  return function (dispatch) {
    ...
    return axios
      .get(WS_URL, { headers: { Authorization: data.token } })
      .then(function (response) {
        return response.data;
      })
      .then(function (data) {
...
export function getPendingInventories(data) {
  return function (dispatch) {
    ...
    return axios
      .get(WS_URL + "pending", { headers: { Authorization: data.token } })
      .then(function (response) {
        return response.data;
      })
      .then(function (data) {
...
export function approveInventory(data) {
  ...
  return function (dispatch) {
    ...
    return axios
      .put(WS_URL + inventory.id + "/approve", null, {
...
export function deleteInventory(data) {
  ...
  return function (dispatch) {
    ...
    return axios
      .delete(WS_URL + inventory.id, { headers: { Authorization: data.token } })
      .then(function (response) {
        return response.data;
      })
      .then(function (data) {
...
export function updateInventory(inventory) {
  return function (dispatch) {
    ...
    return axios
      .put(WS_URL + inventory.id, inventory)
      .then(function (response) {
        return response.data;
      })
      .then(function (data) {
