import {
  ADD_INVENTORY_STARTED,
  ADD_INVENTORY_FULFILLED,
  ADD_INVENTORY_REJECTED,
} from "./../actions/InventoryActions";
import {
  GET_INVENTORIES_STARTED,
  GET_INVENTORIES_FULFILLED,
  GET_INVENTORIES_REJECTED,
} from "./../actions/InventoryActions";
import {
  DELETE_INVENTORY_STARTED,
  DELETE_INVENTORY_FULFILLED,
  DELETE_INVENTORY_REJECTED,
} from "./../actions/InventoryActions";
import {
  GET_PENDING_INVENTORIES_STARTED,
  GET_PENDING_INVENTORIES_FULFILLED,
  GET_PENDING_INVENTORIES_REJECTED,
} from "./../actions/InventoryActions";
import {
  UPDATE_INVENTORY_STARTED,
  UPDATE_INVENTORY_FULFILLED,
  UPDATE_INVENTORY_REJECTED,
} from "./../actions/InventoryActions";
  ...
  switch (action.type) {
    ...
    case GET_INVENTORIES_REJECTED: {
      ...
      return {
        ...state,
        isFetchingInventories: false,
        fetchingInventoriesError: error,
      };
    }
    ...
    case DELETE_INVENTORY_REJECTED: {
      ...
      return {
        ...state,
        isDeletingInventory: false,
        deletingsInventoriesError: error,
      };
    }
    ...
    case GET_PENDING_INVENTORIES_REJECTED: {
      ...
      return {
        ...state,
        isFetchingPendingInventories: false,
        fetchingPendingInventoriesError: error,
      };
    }
    ...
    case UPDATE_INVENTORY_REJECTED: {
      ...
      return {
        ...state,
        isUpdatingInventory: false,
        updatingInventoriesError: error,
      };
    }
